...
            </button>
            {modelDropdownOpen && (
              <div className="absolute top-full right-4 left-4 md:left-auto md:right-0 mt-2 w-auto md:w-80 bg-[var(--color-sidebar)] backdrop-blur-xl border border-[var(--color-border)] rounded-xl shadow-2xl z-50 max-h-[32rem] overflow-y-auto animate-fade-in-up model-dropdown">
...
            </button>
            {libraryOpen && (
              <div className="absolute top-full right-4 left-4 md:left-auto md:right-0 mt-2 w-auto md:w-80 bg-[var(--color-sidebar)] backdrop-blur-xl border border-[var(--color-border)] rounded-xl shadow-2xl z-50 animate-fade-in-up model-dropdown">
